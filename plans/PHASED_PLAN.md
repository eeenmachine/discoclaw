...
- [x] Add a small script (optional) to copy/sync selected “weston” artifacts into the new data root.
...
- 2026-02-09: Added CI workflow, rollout checklist, and migration script from legacy weston content.
